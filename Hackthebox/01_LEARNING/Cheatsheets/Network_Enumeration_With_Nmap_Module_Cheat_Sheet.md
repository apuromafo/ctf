...
-PE
Performs the ping scan by using ICMP Echo Requests against the
target.
--packet-trace
...
--top-ports=
<num>
Scans the specified top ports that have been defined as most
frequent.
-p-
Scan all ports.
-p22-110
...
-D RND:5
Sets the number of random Decoys that will be used to scan the
target.
-e
...
-oA
filename
Stores the results in all available formats starting with the name of
"filename".
-oN
filename
...
--min-rate 300
Sets the number of packets that will be sent
simultaneously.
-T <0-5>
