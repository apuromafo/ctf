...
|---|-----------------|----------------|
| 1 | Write-up PDF | `Brutus_.pdf` |
| 2 | Ficha con tasks (`index.md`, pendiente de traducir ZH→ES/EN) | `index.md` |

## 🎯 Objetivo / Objective

> **ES:** Resolver las tasks del sherlock siguiendo el write-up adjunto.
> **EN:** Solve the sherlock tasks following the attached write-up.
