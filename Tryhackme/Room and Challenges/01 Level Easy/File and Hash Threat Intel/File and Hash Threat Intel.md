...
## 🛡️ Resumen de Investigación de Amenazas (Lab THM) / Threat Research Summary (THM Lab)

### **1. Heurística y Nombres de Archivo / 1. Heuristics and File Names**
...
### **2. Análisis del Malware "bl0gger" / 2. Malware "bl0gger" Analysis**
...
### **3. Análisis del Malware "Morse-Code-Analyzer" / 3. Malware "Morse-Code-Analyzer" Analysis**
...
### **4. Ransomware Akira (Task 5) / 4. Ransomware Akira (Task 5)**
...
### **Puntos clave que este lab refuerza / Key points this lab reinforces:**
