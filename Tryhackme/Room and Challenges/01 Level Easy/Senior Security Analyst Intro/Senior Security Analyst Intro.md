...
| **Dificultad** | Easy |
| **Tipo** | Walkthrough |
| **Slug** | `seniorsecanalystintro` |
| **Link** | [TryHackMe](https://tryhackme.com/room/seniorsecanalystintro) |
| **Sección** | 01 Level Easy |
| **Fuente** | Redacción oficial de TryHackMe + static-site "Your Day as Level 2" |
| **Componentes** | SOC L1 → L2 / soft skills + tech skills / attacker mindset / SAL2 |
| **Impacto** | Transición de L1 a L2: cambiar de "ticket closer" a alguien que ve el panorama completo |

---

**Contexto:** El salto de L1 a L2 no es solo técnico: requiere **both** soft y tech skills. Áreas nuevas de L2: threat hunting, escalation, reportes a stakeholderes y colaboración con DFIR. Explorar nuevas áreas de seguridad te hace crecer (**Yea**). La mentalidad clave es la del **attacker mindset**: pensar cómo escalaría y lateralizara un atacante real para ver patrones que el L1 no detecta. El static-site te sitúa en un día real de un L2 con tasks que cambian entre triage, reportes y hunting.
...
**MITRE ATT&CK:** No aplica técnicas ofensivas directas; se alinea al rol de L2 SOC (Detection & Analysis)

**Fuente:** [TryHackMe - Senior Security Analyst Intro](https://tryhackme.com/room/seniorsecanalystintro)
