...
## Writeup Completo del CTF: De Explotación de Heap a Flag de Root / Complete CTF Writeup: From Heap Exploit to Root Flag

---

## Resumen del Desafío / Challenge Overview
