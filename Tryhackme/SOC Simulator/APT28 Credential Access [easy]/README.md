# APT28: Credential Access [EASY]

## 📊 Información de la Sala / Room Information
- **ID Interno / Internal ID:** `7b97f9e5-026c-41e9-847e-d53e8cd26283`
- **Nivel / Level:** `EASY`
- **Recompensa / Reward:** `100 XP`

## 🎯 Objetivos / Objectives
- Identify and triage security alerts indicating malicious behaviour consistent with APT28 activity.
- Examine techniques used by APT28 to access and steal credentials within enterprise systems.
