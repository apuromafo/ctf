# APT28: Execution [EASY]

## 📊 Información de la Sala / Room Information
- **ID Interno / Internal ID:** `967233bb-337d-4afe-9d5e-6ea4791aba26`
- **Nivel / Level:** `EASY`
- **Recompensa / Reward:** `140 XP`

## 🎯 Objetivos / Objectives
- Identify and triage security alerts indicating malicious behaviour consistent with APT28 activity.
- Investigate how APT28 performs execution and maintains C2 communication within enterprise networks.
