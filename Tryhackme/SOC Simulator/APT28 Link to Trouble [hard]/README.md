# APT28: Link to Trouble [HARD]

## 📊 Información de la Sala / Room Information
- **ID Interno / Internal ID:** `6682c0ec-c9c5-4c94-af89-1f7cbacf2b3d`
- **Nivel / Level:** `HARD`
- **Recompensa / Reward:** `810 XP`

## 🎯 Objetivos / Objectives
- Identify and triage security alerts indicating malicious behaviour consistent with APT28 activity.
- Explore methods for gaining access, persistence, and privilege escalation in enterprise environments attributed to APT28.
