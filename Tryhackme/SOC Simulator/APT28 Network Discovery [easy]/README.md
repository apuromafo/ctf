# APT28: Network Discovery [EASY]

## 📊 Información de la Sala / Room Information
- **ID Interno / Internal ID:** `a9a10858-d021-4a08-8209-00f29f39dfe6`
- **Nivel / Level:** `EASY`
- **Recompensa / Reward:** `170 XP`

## 🎯 Objetivos / Objectives
- Identify and triage security alerts indicating malicious behaviour consistent with APT28 activity.
- Analyse how APT28 conducts network discovery within enterprise environments.
