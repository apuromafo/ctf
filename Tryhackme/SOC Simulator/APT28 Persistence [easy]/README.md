# APT28: Persistence [EASY]

## 📊 Información de la Sala / Room Information
- **ID Interno / Internal ID:** `f22a530a-37a3-4f75-8d6c-d98b48ed2af7`
- **Nivel / Level:** `EASY`
- **Recompensa / Reward:** `150 XP`

## 🎯 Objetivos / Objectives
- Identify and triage security alerts indicating malicious behaviour consistent with APT28 activity.
- Examine APT28’s discovery processes and persistence mechanisms.
