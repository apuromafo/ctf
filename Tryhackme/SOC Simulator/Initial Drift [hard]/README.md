...
- **ID Interno / Internal ID:** `a8a8be76-aa75-4800-908a-b99de2469503`
- **Nivel / Level:** `HARD`
- **Recompensa / Reward:** `760 XP`
...
### 1. Gestión de Eventos e Información de Seguridad (SIEM) / Security Information and Event Management (SIEM)
...
### 2. Estación de Trabajo del Analista (Mi Computadora) / Analyst Workstation (My Computer)
...
## Documentación de Triaje de Alertas / Alert Triage Documentation
