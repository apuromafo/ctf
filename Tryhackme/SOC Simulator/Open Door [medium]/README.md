...
2. **Investigate in the SIEM**:
   ...
   - **Use Analyst VM**: From the "Analyst VM", open the TryDetectMe app to check the threat score of found indicators
...
| William Brown     | DevOps         | william.brown@tryhatme.com    | win-1102       | 10.11.117.250   |
| Amelia Wilson     | DevOps         | amelia.wilson@tryhatme.com    | win-1103       | 10.11.117.50    |
| Edward Harris     | DevOps         | edward.harris@tryhatme.com    | win-1104       | 10.11.117.70    |
| Isabella Smith    | Marketing      | isabella.smith@tryhatme.com   | win-1105       | 10.11.117.90    |
| Oliver Davis      | Sales          | oliver.davis@tryhatme.com     | win-1106       | 10.11.117.110   |
