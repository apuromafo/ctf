...
> **ES/EN** — Guía de la plataforma SOC Simulator de TryHackMe.
> Guide to TryHackMe's SOC Simulator platform.
...
## 01. Bienvenido al Simulador de SOC / Welcome to SOC Simulator
![00](./IMG/00.png)
...
## 02. Experimenta ataques en tiempo real / Experience realtime attacks.
...
## 03. Triaje de alertas en colas realistas / Triage attacks in realistic alert queues.
...
## 04. Realiza análisis forense de artefactos maliciosos / Perform forensics on malicious artifacts.
...
## 05. Investiga registros de eventos en Splunk / Investigate event logs in Splunk.
...
## 06. Cierra alertas con informes escritos / Close out alerts with written reports.
...
## 07. Retroalimentación instantánea impulsada por IA / Instant feedback, powered by AI.
...
## 08. Mide el progreso y el rendimiento / Measure progress and performance.
...
## 09. Monitorea el progreso en el tiempo / Monitor progress in time.
...
## 10. Identifica brechas de habilidades / Identify skill gaps.
...
## 11. ¿Te gusta lo que ves? / Like what you see?
