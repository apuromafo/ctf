# Upload and Conquer [EASY]

## 📊 Información de la Sala / Room Information
- **ID Interno / Internal ID:** `4b9efbd5-110a-4260-bd0a-91d23a900c69`
- **Nivel / Level:** `EASY`
- **Recompensa / Reward:** `740 XP`
...
- **Web Access Logs**: Apache web access logs from TryHatMe e-commerce website.
...
| Name              | Email                          | Host      | Department |
|-------------------|--------------------------------|-----------|------------|
| Michael Ascot     | michael.ascot@tryhatme.com     | win-3450  | CEO        |
| Sophie J          | sophie.j@tryhatme.com          | win-3461  | HR         |
| Michelle Smith    | michelle.smith@tryhatme.com    | win-3459  | Legal      |
| Roger Fedora      | roger.fedora@tryhatme.com      | win-3460  | Marketing  |
| Yani Zubair       | yani.zubair@tryhatme.com       | win-3449  | IT         |
| Miguel O'Donnell  | miguel.odonnell@tryhatme.com   | win-3451  | Sales      |
| Cain Omoore       | cain.omoore@tryhatme.com       | win-3452  | Sales      |
| Kyra Flores       | kyra.flores@tryhatme.com       | win-3453  | Sales      |
| Amna Espinoza     | amna.espinoza@tryhatme.com     | win-3454  | Sales      |
| Ashwin Johnston   | ashwin.johnston@tryhatme.com   | win-3455  | Sales      |
| Safa Prince       | safa.prince@tryhatme.com       | win-3456  | Sales      |
| Diego Summers     | diego.summers@tryhatme.com     | win-3457  | Sales      |
| Armaan Terry      | armaan.terry@tryhatme.com      | win-3458  | Sales      |
