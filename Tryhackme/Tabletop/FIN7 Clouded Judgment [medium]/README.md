# 📋 FIN7: Clouded Judgment [MEDIUM]

![Thumbnail](thumbnail.png)

## 📈 Resumen Ejecutivo / Executive Summary
- **Industria / Industry:** Financial Services
- **Tipo de Ataque / Attack Type:** Financial Fraud
- **Arquitectura / Architecture:** Cloud
- **Sistemas Operativos / OS:** Windows, Mac

## 📝 Contexto del Incidente / Incident Context
Your finance team flags irregularities in payment records that appear to originate from internal systems. A potential financial incident is unfolding, and leadership expects rapid clarification and containment.
